...
export default function TomatoShowcase({ content }: TomatoShowcaseProps) {
  ...
  return (
    <section
      id="tomatoes"
      className="py-24 sm:py-32 px-5 sm:px-8 bg-warm-canvas relative overflow-hidden"
    >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 sm:mb-18 reveal-child">
          ...
          <div className="md:max-w-xs md:text-end">
            <p className="text-sm text-[#4E5E52] leading-relaxed font-arabic">
              {t(content.tomatoesSection.description)}
            </p>
            <div className="hidden md:block mt-3">
              <ArabesqueDivider variant="terracotta" size="sm" className="justify-end my-1" />
            </div>
          </div>
        </div>
        ...
        {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            ...
            ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
        {signatureTomato && (
          <div className="mb-12 sm:mb-16 reveal-child">
            <Link
              href={`/products/${signatureTomato.id}`}
              className="group block relative rounded-organic-1 bg-white border border-[#E8DFD1] hover:border-[#C85A32]/70 shadow-organic-md shadow-organic-hover overflow-hidden transition-all duration-300"
            >
          ...
          {artisanalTomatoes.map((item, index) => {
            ...
            return (
              <Link
                ...
                className={`reveal-child group block bg-white border border-[#E8DFD1] hover:border-[#C85A32] shadow-organic-sm shadow-organic-hover overflow-hidden transition-all duration-300 ${cornerClass} ${rotationClass}`}
              >
                {/* Image Container */}
